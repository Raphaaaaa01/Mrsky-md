...
smd(
   ...
   async (_0x514d3c) => {
     ...
     _0x514d3c.reply("😢Mrsky Shutting Down");
...
smd({
  ...
  _0x514d3c.reply("Your Restarting Mrsky Md ♻");
...
smd({
  ...
  try {
    ...
    return await _0x2a10d6.send(!_0x4e5e2e ? "*_🙆 There's no plugin install in " + Config.botname + "_*" : !_0x2420b0 ? "*All Installed Modules are:-*\n\n" + _0x4e5e2e : _0x4e5e2e);
  } catch (_0x21e335) {
...
smd({
  ...
  if (!_0x40e763) {
    return await _0x1510c9.reply("*_🙏 Please, Provide Me Mrsky Plugin Name_*");
  }
  if (_0x40e763 === "alls") {
...
smd({
  ...
  if (!_0x2b0828.toLowerCase().includes("https://github.com/mrsky-cyber/Mrsky-md-plugins/plugins")) {
    return await _0xf71b5c.send("*_🙏 Please, Provide Me Mrsky Plugin Url_*");
  }
