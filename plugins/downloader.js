...
`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am Mrsky-Md whatsapp bot._*");
     }
     try {
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *🄼🅁🅂🄺🅈-ᴍᴅ Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *🍔Name* : ${result.name}\n *🍔Size* : ${result.size}\n *🍔Mime* : ${result.mime}\n\n\n${Config.caption}`;
...
smd({
 ...
 cmd({
   ...
   try {
     ...
     let _0x4186e4 = "*🄼🅁🅂🄺🅈-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ* \n*=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿=̿* \n\n_Reply Any Number To Download._\n  _For Audio: 1 mp3._\n  _For Video: 1 video._\n  _For document: 1 document._\n\n_Results For : " + _0xca939c + "_ \n\n";
     let _0x463366 = 1;
 ...
 cmd({
   ...
   if (_0xb75e78.quoted && _0xb75e78.text) {
     ...
     if (_0x5b8ee5[0].includes("🄼🅁🅂🄺🅈-ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
     ...
     } else if (_0x5b8ee5[0].includes("🄼🅁🅂🄺🅈-ᴍᴅ • ʏᴏᴜᴛᴜʙᴇ ᴅᴏᴡɴʟᴏᴀᴅ")) {
     ...
     } else if (_0x5b8ee5[0].includes("🄼🅁🅂🄺🅈-ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
